...
import edu.tcu.cs.hogwartsartifactsonline.artifact.ArtifcactRepository;
...
public class DBDataInitializer implements CommandLineRunner {
    ...
    public DBDataInitializer(ArtifcactRepository artifcactRepository, WizardRepository wizardRepository) {
